    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_subject', multiselectfield.db.fields.MultiSelectField(
                    blank=True, choices=[('students', 'Students, applicants'),
                                         ...
                                         ('patients',  'Patients'),
                                         ('supplier', 'Suppliers, professional advisers and '
                                                      'consultants'),
                                         ('public', 'Members of public')],
                    max_length=55, null=True)),
                ('data_category', multiselectfield.db.fields.MultiSelectField(
                    blank=True, choices=[('education', 'Education details'),
                                         ...
                                         ('criminal', 'Criminal proceedings, outcomes and '
                                                      'sentences')],
                    max_length=145, null=True)),
                ('recipients_category', models.CharField(blank=True, max_length=255, null=True)),
                ('recipients_outside_eea', models.CharField(
                    blank=True, max_length=255, null=True)),
                ('retention', models.CharField(
                    blank=True, choices=[('<=1', '1 year or less'),
                                         ('>1,<=5', '>1 to 5 years'),
                                         ('>5,<=10', '>5 to 10 years'),
                ...
                ('risk_type', multiselectfield.db.fields.MultiSelectField(
                    blank=True, choices=[('financial', 'Financial'),
                                         ('operational', 'Operational'),
                                         ('compliance', 'Compliance'),
                                         ('reputational', 'Reputational'),
                                         ('safety', 'Personal Safety')],
                    max_length=52, null=True)),
                ('storage_location', models.CharField(blank=True, max_length=255, null=True)),
                ('storage_format', multiselectfield.db.fields.MultiSelectField(
                    blank=True, choices=[('digital', 'Digital'), ('paper', 'Paper')],
                    max_length=13, null=True)),
                ('paper_storage_security', multiselectfield.db.fields.MultiSelectField(
                    blank=True, choices=[('locked_cabinet', 'Locked filing cabinet'),
                                         ('safe', 'Safe'), ('locked_room', 'Locked room'),
                                         ('locked_building', 'Locked building')],
                    max_length=47, null=True)),
                ('digital_storage_security', multiselectfield.db.fields.MultiSelectField(
                    blank=True, choices=[('pwd_controls', 'Password controls'),
                                         ('acl', 'Access control lists'), ('backup', 'Backup'),
                                         ('encryption', 'Encryption')], max_length=34, null=True)),
